...
#define EXAMPLE_MIPI_DSI_LCD_H_RES 480 // 宽
#define EXAMPLE_MIPI_DSI_LCD_V_RES 480  // 高
...
void app_main(void)
{
    ...
    ESP_ERROR_CHECK(esp_lcd_new_panel_st7802(mipi_dbi_io, &panel_config, &panel_handle));
    ESP_ERROR_CHECK(esp_lcd_panel_reset(panel_handle));
    ESP_ERROR_CHECK(esp_lcd_panel_init(panel_handle));
    ESP_ERROR_CHECK(esp_lcd_panel_st7802_set_brightness(panel_handle, 50));
