...
static esp_err_t app_lcd_init(void)
{
    ...
    esp_lcd_dsi_bus_config_t bus_config = ST7802_PANEL_BUS_DSI_1CH_CONFIG();
    ...
    // 创建ST7802控制面板
    esp_lcd_dpi_panel_config_t dpi_config = ST7802_480_480_PANEL_60HZ_DPI_CONFIG(MIPI_DPI_PX_FORMAT);
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_new_panel_st7802(io_handle, &panel_config, &lcd_panel), err, TAG, "AMOLED init failed");
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_panel_st7802_set_brightness(lcd_panel, 70), err, TAG, "AMOLED init failed");
...
static esp_err_t app_touch_init(void)
{
    ...
    return esp_lcd_touch_new_i2c_cst9220(tp_io_handle, &tp_cfg, &touch_handle);
}
